...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5>{{ __('Employee Month Wise Leave Summary') }}</h5>
        </div>

        <div class="card-body">

           {{ Form::open(['route' => ['leave.index'], 'method' => 'get', 'id' => 'leave_month_filter']) }}

<div class="row align-items-center mb-4">
    <div class="col-md-6">
        <div class="d-flex align-items-center gap-2">
            <label for="leave_month" class="form-label mb-0">{{ __('Month') }}</label>

            <input type="month"
                   name="leave_month"
                   id="leave_month"
                   value="{{ isset($selectedLeaveMonth) ? $selectedLeaveMonth : date('Y-m') }}"
                   class="form-control"
                   style="width: 220px;">
        </div>
    </div>
    ...
    <div class="col-md-6 text-end">
        <a href="#"
           ...
           onclick="document.getElementById('leave_month_filter').submit(); return false;"
        ...
        <button type="button"
                onclick="exportTableToExcel('employee-month-wise-leave-table', 'employee-month-wise-leave.xls')"
...
{{ Form::close() }}
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="employee-month-wise-leave-table">
                    <thead>
                        <tr>
                            <th>{{ __('Sr. No.') }}</th>
                            <th>{{ __('Employee') }}</th>
                    ...
                    <tbody>
                        @forelse ($employeeMonthWiseLeaves as $key => $summary)
                            <tr>
                                <td>{{ $key + 1 }}</td>
...
@push('script-page')
    <script>
        ...
        function exportTableToExcel(tableID, filename = 'employee-month-wise-leave.xls') {

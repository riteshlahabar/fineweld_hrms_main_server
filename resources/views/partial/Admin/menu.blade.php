...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            @if (\Auth::user()->type != 'company')
                ...
                <li class="dash-item"><a href="https://cms.fineweldsystems.com/" target="_blank" class="dash-link"><span class="dash-micon"><i class="ti ti-home"></i></span><span class="dash-mtext">CMS Dashboard</span></a></li>
            @endif
            @if (\Auth::user()->type == 'company')
    ...
    <li class="dash-item dash-hasmenu">
        ...
        <ul class="dash-submenu">
            ...
            <li class="dash-item">
                <a class="dash-link"
                   href="{{ route('attendanceemployee.missedattendance') }}">{{ __('Missed Attendance') }}</a>
            </li>
            <!-- 🔼🔼  END OF NEW LINK  🔼🔼 -->
        </ul>
    </li>
            ...
            @if (Gate::check('Manage Award') ||
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        @can('Manage Travel')
                            <li class="dash-item">
                                <a class="dash-link" href="{{ route('travel.index') }}">{{ __('Customer Visit') }}</a>
                            </li>
                        @endcan

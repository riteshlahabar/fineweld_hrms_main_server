                            ...
                            <div class="card-body employee-detail-create-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="text-xs mt-1">
                                            {{ __('Create designation.') }} <a href="{{ route('designation.index') }}"><b>{{ __('Click here') }}</b></a>
                                       </div>
                                    </div>
                        ...
                        <div class="card em-card">
                            ...
                            <div class="card-body employee-detail-create-body">
                                @if($documents->count() == 0)
                                    <div class="text-danger">{{ __('Please first add document') }}<a href="{{ route('document.index') }}"

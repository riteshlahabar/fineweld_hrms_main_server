...
@push('script-page')
    ...
    <script>
function exportTableToExcel(tableID, filename = 'attendance.xls') {
    ...
    <style>
        .location-cell {
            ...
            line-height: 1.4em;
            max-height: 5.6em; /* 4 lines × 1.4em */
            font-size: 13px;
            color: #4a5568;
        }
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <button onclick="exportTableToExcel('pc-dt-simple')" class="btn btn-sm btn-success">
                            ...
                            <tbody>
                                @foreach ($attendanceEmployee as $attendance)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="location-cell" title="{{ $attendance->location_in ?? '-' }}">
                                                {{ $attendance->location_in ?? '-' }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="location-cell" title="{{ $attendance->location_out ?? '-' }}">
                                        ...
                                        @if (Gate::check('Edit Attendance') || Gate::check('Delete Attendance'))
                                            <td class="Action">
                                                <span class="d-flex">
                                                    ...
                                                    {{-- View Client Visits Icon --}}
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="btn btn-sm bg-success align-items-center"
                                                            data-url="{{ route('attendanceemployee.visits', ['employee_id' => $attendance->employee_id, 'date' => $attendance->date]) }}"
                                                            data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip"
                                                            title="" data-title="{{ __('Client Visits') }}"
                                                            data-bs-original-title="{{ __('View Visits') }}">
                                                            <span class="text-white"><i class="ti ti-map-pin"></i></span>
                                                        </a>
                                                    </div>

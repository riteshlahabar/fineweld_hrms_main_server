...
@section('page-title')
    {{ __('Manage Customer Visit') }}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Home') }}</a></li>
    <li class="breadcrumb-item">{{ __('Customer Visit') }}</li>
@endsection

@section('action-button')
    @can('Create Travel')
        <a href="#" data-url="{{ route('travel.create') }}" data-ajax-popup="true" data-title="{{ __('Create Customer Visit') }}"
                        ...
                        <table class="table" id="pc-dt-simple">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Start Date') }}</th>
                                    <th>{{ __('End Date') }}</th>
                                    <th>{{ __('Purpose of Customer Visit') }}</th>
                                    <th>{{ __('City') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($travels as $travel)
                                    <tr>
                                        @role('company')
                                            <td>{{ optional($travel->employee)->name ?? '-' }}</td>
                                        @endrole

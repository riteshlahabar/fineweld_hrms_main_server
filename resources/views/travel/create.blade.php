...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Form::text('purpose_of_visit', null, ['class' => 'form-control', 'placeholder' => __('Enter Purpose Of Customer Visit'),'required' => 'required']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('place_of_visit', __('City'), ['class' => 'col-form-label']) }}<x-required></x-required>
            {{ Form::text('place_of_visit', null, ['class' => 'form-control', 'placeholder' => __('Enter City Name'),'required' => 'required']) }}
        </div>
        <div class="form-group col-md-12">

    ...
    public static function defaultEmail()
    {
        ...
        $defaultTemplate = [
            ...
            'new_complaint'=>[
                ...
                'lang' => [
                    'ar' => '<p><span style="font-family: sans-serif;"><strong>الموضوع:</strong> تم إنشاء شكوى جديدة</span></p>
                    <p><span style="font-family: sans-serif;">الموظف {complaint_from_name} قدم شكوى ضد الموظف {complaint_against_name} هنا التفاصيل:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>عنوان الشكوى:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>وصف الشكوى:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>تاريخ الشكوى:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">شكراً لك،</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'da' => '<p><span style="font-family: sans-serif;"><strong>Emne:</strong> Ny klage oprettet</span></p>
                    <p><span style="font-family: sans-serif;">Medarbejder {complaint_from_name} har indgivet en klage mod medarbejder {complaint_against_name} Her er detaljerne:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Klagetitel:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Klagedeskrivelse:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Klagedato:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Tak,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'de' => '<p><span style="font-family: sans-serif;"><strong>Thema:</strong> Neue Beschwerde erstellt</span></p>
                    <p><span style="font-family: sans-serif;">Mitarbeiter {complaint_from_name} hat eine Beschwerde gegen Mitarbeiter {complaint_against_name} eingereicht. Hier sind die Details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Beschwerdetitel:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Beschwerdebeschreibung:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Beschwerdedatum:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Danke,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'en' => '<p><span style="font-family: sans-serif;"><strong>Subject:</strong> New Complaint Created</span></p>
                    <p><span style="font-family: sans-serif;">Employee {complaint_from_name} has filed a complaint against employee {complaint_against_name}  Here are the details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Complaint Title:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Complaint Detail:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Complaint Date:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Thank you,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'es' => '<p><span style="font-family: sans-serif;"><strong>Asunto:</strong> Nueva queja creada</span></p>
                    <p><span style="font-family: sans-serif;">El empleado {complaint_from_name} ha presentado una queja contra el empleado {complaint_against_name} Aquí están los detalles:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Título de la queja:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Descripción de la queja:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Fecha de la queja:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Gracias,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'fr' => '<p><span style="font-family: sans-serif;"><strong>Objet :</strong> Nouvelle plainte créée</span></p>
                    <p><span style="font-family: sans-serif;">L\'employé {complaint_from_name} a déposé une plainte contre l\'employé {complaint_against_name} Voici les détails :</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Titre de la plainte :</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Description de la plainte :</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Date de la plainte :</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Merci,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'he' => '<p><span style="font-family: sans-serif;"><strong>נושא:</strong> תלונה חדשה נוצרה</span></p>
                    <p><span style="font-family: sans-serif;">העובד {complaint_from_name} הגיש תלונה נגד העובד {complaint_against_name} להלן הפרטים:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>כותרת התלונה:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>תיאור התלונה:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>תאריך התלונה:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">תודה,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'it' => '<p><span style="font-family: sans-serif;"><strong>Oggetto:</strong> Nuova denuncia creata</span></p>
                    <p><span style="font-family: sans-serif;">Il dipendente {complaint_from_name} ha presentato una denuncia contro il dipendente {complaint_against_name} Ecco i dettagli:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Titolo della denuncia:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Descrizione della denuncia:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data della denuncia:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Grazie,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'ja' => '<p><span style="font-family: sans-serif;"><strong>件名：</strong> 新しい苦情が作成されました</span></p>
                    <p><span style="font-family: sans-serif;">従業員 {complaint_from_name} が従業員 {complaint_against_name} に対して苦情を提出しました。詳細は以下の通りです：</span></p>
                    <p><span style="font-family: sans-serif;"><strong>苦情のタイトル：</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>苦情の説明：</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>苦情の日付：</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">ありがとうございます、</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'nl' => '<p><span style="font-family: sans-serif;"><strong>Onderwerp:</strong> Nieuwe klacht aangemaakt</span></p>
                    <p><span style="font-family: sans-serif;">Medewerker {complaint_from_name} heeft een klacht ingediend tegen medewerker {complaint_against_name} Hier zijn de details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Klacht titel:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Klacht beschrijving:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Klacht datum:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Bedankt,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pl' => '<p><span style="font-family: sans-serif;"><strong>Temat:</strong> Nowa skarga utworzona</span></p>
                    <p><span style="font-family: sans-serif;">Pracownik {complaint_from_name} złożył skargę przeciwko pracownikowi {complaint_against_name} Oto szczegóły:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Tytuł skargi:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Opis skargi:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data skargi:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Dziękuję,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt' => '<p><span style="font-family: sans-serif;"><strong>Assunto:</strong> Nova reclamação criada</span></p>
                    <p><span style="font-family: sans-serif;">O funcionário {complaint_from_name} apresentou uma reclamação contra o funcionário {complaint_against_name} Aqui estão os detalhes:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Título da reclamação:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Descrição da reclamação:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data da reclamação:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Obrigado,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt-br' => '<p><span style="font-family: sans-serif;"><strong>Assunto:</strong> Nova reclamação criada</span></p>
                    <p><span style="font-family: sans-serif;">O funcionário {complaint_from_name} apresentou uma reclamação contra o funcionário {complaint_against_name} Aqui estão os detalhes:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Título da reclamação:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Descrição da reclamação:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data da reclamação:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Obrigado,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'ru' => '<p><span style="font-family: sans-serif;"><strong>Тема:</strong> Создана новая жалоба</span></p>
                    <p><span style="font-family: sans-serif;">Сотрудник {complaint_from_name} подал жалобу на сотрудника {complaint_against_name} Вот подробности:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Заголовок жалобы:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Описание жалобы:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Дата жалобы:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Спасибо,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;"><strong>Konu:</strong> Yeni şikayet oluşturuldu</span></p>
                    <p><span style="font-family: sans-serif;">Çalışan {complaint_from_name}, çalışan {complaint_against_name} hakkında şikayet dilekçesi verdi. İşte detaylar:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Şikayet Başlığı:</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Şikayet Açıklaması:</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Şikayet Tarihi:</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">Teşekkür ederim,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'zh' => '<p><span style="font-family: sans-serif;"><strong>主题：</strong> 新投诉已创建</span></p>
                    <p><span style="font-family: sans-serif;">员工 {complaint_from_name} 对员工 {complaint_against_name} 提出投诉。以下是详细信息：</span></p>
                    <p><span style="font-family: sans-serif;"><strong>投诉标题：</strong> {complaint_title}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>投诉描述：</strong> {complaint_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>投诉日期：</strong> {complaint_date}</span></p>
                    <p><span style="font-family: sans-serif;">谢谢,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                ],
            ],
            'new_warning' => [
                'subject' => 'New Warning',
                'lang' => [
                    'ar' => '<p><span style="font-family: sans-serif;"><strong>الموضوع:</strong> تم إنشاء تحذير جديد</span></p>
                    <p><span style="font-family: sans-serif;">الموظف {warning_by} قدم تحذيراً ضد الموظف {warning_to} هنا التفاصيل:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>موضوع التحذير:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>تفاصيل التحذير:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>تاريخ التحذير:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">شكراً لك،</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'da' => '<p><span style="font-family: sans-serif;"><strong>Emne:</strong> Ny advarsel oprettet</span></p>
                    <p><span style="font-family: sans-serif;">Medarbejder {warning_by} har givet en advarsel til medarbejder {warning_to} Her er detaljerne:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Advarselsemne:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Advarselsdetalje:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Advarselsdato:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Tak,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'de' => '<p><span style="font-family: sans-serif;"><strong>Thema:</strong> Neue Warnung erstellt</span></p>
                    <p><span style="font-family: sans-serif;">Mitarbeiter {warning_by} hat eine Warnung gegen Mitarbeiter {warning_to} ausgesprochen. Hier sind die Details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Warnungsthema:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Warnungsdetails:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Warnungsdatum:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Danke,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'en' => '<p><span style="font-family: sans-serif;"><strong>Subject:</strong> New Warning Created</span></p>
                    <p><span style="font-family: sans-serif;">Employee {warning_by} has filed a warning against employee {warning_to} Here are the details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Warning Subject:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Warning Detail:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Warning Date:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Thank you,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'es' => '<p><span style="font-family: sans-serif;"><strong>Asunto:</strong> Nueva advertencia creada</span></p>
                    <p><span style="font-family: sans-serif;">El empleado {warning_by} ha emitido una advertencia contra el empleado {warning_to} Aquí están los detalles:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Asunto de la advertencia:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Detalle de la advertencia:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Fecha de la advertencia:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Gracias,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'fr' => '<p><span style="font-family: sans-serif;"><strong>Objet :</strong> Nouvel avertissement créé</span></p>
                    <p><span style="font-family: sans-serif;">L\'employé {warning_by} a émis un avertissement contre l\'employé {warning_to} Voici les détails :</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Sujet de l\'avertissement :</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Détail de l\'avertissement :</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Date de l\'avertissement :</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Merci,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'he' => '<p><span style="font-family: sans-serif;"><strong>נושא:</strong> נוצרה אזהרה חדשה</span></p>
                    <p><span style="font-family: sans-serif;">העובד {warning_by} הגיש אזהרה נגד העובד {warning_to} להלן הפרטים:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>נושא האזהרה:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>פרטי האזהרה:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>תאריך האזהרה:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">תודה,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'it' => '<p><span style="font-family: sans-serif;"><strong>Oggetto:</strong> Nuovo avvertimento creato</span></p>
                    <p><span style="font-family: sans-serif;">Il dipendente {warning_by} ha emesso un avvertimento contro il dipendente {warning_to} Ecco i dettagli:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Oggetto dell\'avvertimento:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Dettaglio dell\'avvertimento:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data dell\'avvertimento:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Grazie,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'ja' => '<p><span style="font-family: sans-serif;"><strong>件名：</strong> 新しい警告が作成されました</span></p>
                    <p><span style="font-family: sans-serif;">従業員 {warning_by} が従業員 {warning_to} に対して警告を出しました。詳細は以下の通りです：</span></p>
                    <p><span style="font-family: sans-serif;"><strong>警告の件名：</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>警告の詳細：</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>警告の日付：</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">ありがとうございます、</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'nl' => '<p><span style="font-family: sans-serif;"><strong>Onderwerp:</strong> Nieuwe waarschuwing aangemaakt</span></p>
                    <p><span style="font-family: sans-serif;">Medewerker {warning_by} heeft een waarschuwing ingediend tegen medewerker {warning_to} Hier zijn de details:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Waarschuwing onderwerp:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Waarschuwing detail:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Waarschuwingsdatum:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Bedankt,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pl' => '<p><span style="font-family: sans-serif;"><strong>Temat:</strong> Utworzono nowe ostrzeżenie</span></p>
                    <p><span style="font-family: sans-serif;">Pracownik {warning_by} wystawił ostrzeżenie przeciwko pracownikowi {warning_to} Oto szczegóły:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Temat ostrzeżenia:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Szczegóły ostrzeżenia:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data ostrzeżenia:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Dziękuję,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt' => '<p><span style="font-family: sans-serif;"><strong>Assunto:</strong> Novo aviso criado</span></p>
                    <p><span style="font-family: sans-serif;">O funcionário {warning_by} emitiu um aviso contra o funcionário {warning_to} Aqui estão os detalhes:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Assunto do aviso:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Detalhe do aviso:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data do aviso:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Obrigado,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'pt-br' => '<p><span style="font-family: sans-serif;"><strong>Assunto:</strong> Novo aviso criado</span></p>
                    <p><span style="font-family: sans-serif;">O funcionário {warning_by} emitiu um aviso contra o funcionário {warning_to} Aqui estão os detalhes:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Assunto do aviso:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Detalhe do aviso:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data do aviso:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Obrigado,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'ru' => '<p><span style="font-family: sans-serif;"><strong>Тема:</strong> Создано новое предупреждение</span></p>
                    <p><span style="font-family: sans-serif;">Сотрудник {warning_by} вынес предупреждение сотруднику {warning_to} Вот подробности:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Тема предупреждения:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Детали предупреждения:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Дата предупреждения:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Спасибо,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;"><strong>Konu:</strong> Yeni uyarı oluşturuldu</span></p>
                    <p><span style="font-family: sans-serif;">Çalışan {warning_by}, çalışan {warning_to} hakkında bir uyarı verdi. İşte detaylar:</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Uyarı Konusu:</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Uyarı Detayı:</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Uyarı Tarihi:</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">Teşekkür ederim,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                    'zh' => '<p><span style="font-family: sans-serif;"><strong>主题：</strong> 新警告已创建</span></p>
                    <p><span style="font-family: sans-serif;">员工 {warning_by} 对员工 {warning_to} 发出了警告。以下是详细信息：</span></p>
                    <p><span style="font-family: sans-serif;"><strong>警告主题：</strong> {warning_subject}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>警告详情：</strong> {warning_detail}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>警告日期：</strong> {warning_date}</span></p>
                    <p><span style="font-family: sans-serif;">谢谢,</span></p>
                    <p><span style="font-family: sans-serif;">{company_name}</span></p>',
                ],
            ],
